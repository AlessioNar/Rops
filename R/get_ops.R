...
#' @param fromRange Initial limit of results to be returned. Default to 1
#' @param toRange Final limit of results to be returned. Default to 100
...
get_ops <- function(url, access_token, raw = NULL, fromRange = 1, toRange = 100){
  ...
  # Create header
  header <- c(paste('Bearer', access_token), "application/json", paste0(fromRange, "-", toRange))
  # Rename header
